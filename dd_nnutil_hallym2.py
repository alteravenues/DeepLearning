...
def load_dataset(folder, nclasses = 6,  test_ratio = 0.3):
    xTrain=[]
    yTrain=[]
    xTest =[]
    yTest =[]
...
def load_image_test(folder, img_class, idx=0):
    
    ftypes = ('jpg', 'JPG')
    listc1=[]
    for ftype in ftypes:
        fnfmt = '{}/{}/*.{}'.format(folder, img_class, ftype)
        #print(fnfmt)
        listc1.extend(sorted(glob.glob(fnfmt)))
